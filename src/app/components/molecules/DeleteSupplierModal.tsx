...
const DeleteSupplierModal = ({ isMutationPending, isOpen, onDelete, onClose, onOpenChange }: Props) => {
    ...
    return (
        ...
        >
            <ModalContent>
                {(onClose) => (
                    <>
                        <ModalHeader className="flex flex-col gap-1 pb-1">Delete Supplier</ModalHeader>
                        <ModalBody className='gap-7 pb-5'>
                            <form onSubmit={handleFormSubmit} className='flex flex-col gap-5'>
                                <p className='mb-0'>Are you sure? Deleting a supplier is irreversible!</p>
