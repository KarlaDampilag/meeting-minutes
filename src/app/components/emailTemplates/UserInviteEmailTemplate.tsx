...
export const UserInviteEmailTemplate: React.FC<Readonly<EmailTemplateProps>> = ({
    ...
    <div>
        ...
        <p>To accept this invitation and start using {process.env.NEXT_PUBLIC_APP_NAME}, click on the button below:</p>
        <Button href={`${process.env.NEXT_PUBLIC_APP_URL}/accept-invite?id=${inviteId}`} className='bg-primary px-4 py-3'>Accept Invite</Button>
    </div>
);
