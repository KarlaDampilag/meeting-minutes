...
export const UserInviteEmailTemplate: React.FC<Readonly<EmailTemplateProps>> = ({
    ...
    <div>
        ...
        <p>To accept this invitation and start using {process.env.NEXT_PUBLIC_APP_NAME}, click on this link: <Link href={`${process.env.NEXT_PUBLIC_APP_URL}/sign-up?id=${inviteId}`} className='bg-primary px-4 py-3'>Sign up</Link></p> 
    </div>
);
